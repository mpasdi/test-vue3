...
<script setup lang="ts">
  ...
  // echarts
  async function init() {
    echarts.registerMap('ChinaMap', { svg: svgStr })
    ...
    ;[['上海', chinaDatas]].forEach(function (item: any) {
      series.push(
        {
          type: 'lines',
          zlevel: 2,
    ...
    const option = {
      ...
      geo: {
        ...
        itemStyle: {
          ...
          emphasis: {
            // areaColor: 'orange', //悬浮背景
            // areaColor: 'tranparent' //悬浮背景
            // textStyle: {
            //   color: '#fff'
            // }
          }
